        ...
        <div id="login-page">
            <div class="container">
                <form class="form-login" name="login" method="post" action="usercheck.php" ><br>
                    <div style="text-align: center"><h2 style="font-size: 33px; color: tomato; padding-top: 80px;">Public User Login</h2></div>
                ...
                <div style="margin: 50px; text-align: center;font-size: 110%;">
