...
<form  method="post" class="w3-container">       
        ...
        <br>	
        Complaint Description (With Address)
        <br><br>
        <textarea id="subject" name="narration" placeholder="Describe your complaint.." style="height:200px; width:100%;resize: vertical;" required></textarea>
...
$(document).ready(function(){
    $('#district').on('change', function(){									/*"district" is the id in select tag*/
        var districtId = $(this).val();
        if(districtId){
            $.ajax({
                type:'POST',
                url:'departmentbydistrict.php',
                data:'districtId='+districtId,  /*it sends selected districtid to this url ;ajax calls for dropdown results*/
...
<!-- I call departmentbydistrict.php via AJAX by sending selected district(id) -->